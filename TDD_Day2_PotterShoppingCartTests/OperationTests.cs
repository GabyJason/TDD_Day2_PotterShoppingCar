...
namespace TDD_Day2_PotterShoppingCart.Tests
{
    ...
    public class OperationTests
    {
        ...
        [TestMethod]
        public void Test_一二集各買一本_第三集買兩本()
        {
            //Arrange
            Operation target = new Operation();
            int expected = 370;
            ...
            Cart.Add(new Book { StortName = "Harry Potter_Episode1", Quantity = 1, Price = 100 });
            Cart.Add(new Book { StortName = "Harry Potter_Episode2", Quantity = 1, Price = 100 });
            Cart.Add(new Book { StortName = "Harry Potter_Episode3", Quantity = 2, Price = 100 });
        ...
        [TestMethod]
        public void Test_第一集買一本_第二三集各買兩本()
        {
            //Arrange
            Operation target = new Operation();
            int expected = 460;
            ...
            var Cart = new List<Book>();
            Cart.Add(new Book { StortName = "Harry Potter_Episode1", Quantity = 1, Price = 100 });
            Cart.Add(new Book { StortName = "Harry Potter_Episode2", Quantity = 2, Price = 100 });
            Cart.Add(new Book { StortName = "Harry Potter_Episode3", Quantity = 2, Price = 100 });
